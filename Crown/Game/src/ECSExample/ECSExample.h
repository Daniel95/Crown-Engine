...
class ECSExample : public Crown::Application
{
protected:
...
private:
    std::shared_ptr<Crown::TransformComponentSystem> m_TransformComponentSystem;
    std::shared_ptr<Crown::RenderComponentSystem> m_RenderComponentSystem;
